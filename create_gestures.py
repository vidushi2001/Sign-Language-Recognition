...
def init_create_folder_database():
        ...
        if not os.path.exists("C:\\Users\\Dino\\Desktop\\Sign-Language-Recognition\\Code\\gestures"):
                os.mkdir("gestures")
        if not os.path.exists("C:\\Users\\Dino\\Desktop\\Sign-Language-Recognition\\Code\\gesture_db.db"):
                conn = sqlite3.connect("C:\\Users\\Dino\\Desktop\\Sign-Language-Recognition\\Code\\gesture_db.db")
...
def store_images(g_id):
        ...
        while True:
                ...
                if len(contours) > 0:
                        ...
                        #        countours1 = cv2.contourArea(contours[0][i])
